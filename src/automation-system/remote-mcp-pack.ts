...
function buildQuickStartCalls(baseUrl: string): RemoteMcpConnectionPack["quickStartCalls"] {
  ...
  return withExactMcpCalls([
    ...
    {
      label: "Build leadgen target backfill runbook",
      tool: "arcigy.build_leadgen_target_backfill_preview",
      method: "POST",
      url: toolUrl("arcigy.build_leadgen_target_backfill_preview"),
      body: {
    ...
    {
      label: "Build Gmail AI reply safety runbook",
      tool: "arcigy.build_gmail_ai_reply_safety_runbook_preview",
      method: "POST",
      url: toolUrl("arcigy.build_gmail_ai_reply_safety_runbook_preview"),
      body: {
        targetLabel: "COLD-OUTREACH",
        aiRepliesActive: true,
        messages: [
