...
const capabilityDefinitions: CapabilityDefinition[] = [
  ...
  },
  {
    ...
    approvalRequired: ["arcigy.create_smartlead_campaign", "arcigy.configure_smartlead_campaign", "arcigy.add_leads_to_smartlead_campaign", "arcigy.append_leads_to_google_sheet"],
