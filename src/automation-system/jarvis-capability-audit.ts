...
const capabilityDefinitions: CapabilityDefinition[] = [
  ...
  },
  {
    ...
    approvalRequired: ["arcigy.export_leads_csv", "arcigy.label_gmail_thread", "arcigy.create_smartlead_campaign", "arcigy.configure_smartlead_campaign", "arcigy.add_leads_to_smartlead_campaign", "arcigy.append_leads_to_google_sheet", "arcigy.replace_google_sheet_rows"],
