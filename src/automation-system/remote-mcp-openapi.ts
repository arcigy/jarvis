...
function examplePayloadForTool(toolName: string): Record<string, unknown> {
  ...
  if (toolName === "arcigy.lookup_public_email_profile") return { email: "jan.novak@example.com", companyName: "Modelova Firma", website: "https://example.com", sourceName: "lead-enrichment" };
  ...
  if (toolName === "arcigy.build_gmail_outreach_readiness_preview") {
    return {
      ...
      replyEvents: [{ source: "gmail", accountEnvKey: "GMAIL_REFRESH_TOKEN_BRANISLAV_ARCIGY_GROUP", threadId: "thread-123", email: "lead@example.com", leadName: "Jan Novak", companyName: "Modelova Firma", replyBody: "Dobry den, poslite mi prosim ukazku.", category: "positive" }],
  ...
  if (toolName === "arcigy.build_sticky_niche_leadgen_decision_preview") {
    return {
      date: "2026-06-10",
      niches: [
  ...
  if (toolName === "arcigy.build_bulk_smartlead_upload_queue_preview") {
    return {
      campaigns: [
        {
          niche: { id: "niche-1", slug: "autoservisy", name: "Autoservisy", campaignId: "123456" },
  ...
  if (toolName === "arcigy.build_smartlead_local_reconciliation_preview") {
    return {
      campaignId: "123456",
      localLeads: [
  ...
  if (toolName === "arcigy.build_smartlead_safe_sync_runbook_preview") {
    return {
      campaignId: "123456",
  ...
  if (toolName === "arcigy.build_smartlead_campaign_audit_preview") {
    return {
      campaigns: [
  ...
  if (toolName === "arcigy.build_smartlead_workspace_diagnostic_preview") {
    return {
      endpointChecks: [
  ...
  if (toolName === "arcigy.build_leadgen_progress_watchdog_preview") {
    return {
