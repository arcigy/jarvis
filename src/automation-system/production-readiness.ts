...
const coreWorkflowSurfaces: CoreWorkflowSurface[] = [
  ...
  },
  {
    ...
    proof: "Smartlead/local outreach briefs, Gemini positive reply drafts, reply-decision previews, Smartlead thread draft, approval queue, and approval-gated sends are registered.",
  },
  {
