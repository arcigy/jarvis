...
export function listJarvisMcpTools(): JarvisMcpTool[] {
  return [
    ...
    {
      name: "arcigy.build_pricing_inventory_guard_preview",
      description: "Read-only pricing guard z pricing MCP: skontroluje dostupnost produktov/sluzieb, zlavu, minimalnu cenu a marzu pred ponukou.",
      requiresApproval: false,
    },
    {
    ...
    {
      name: "arcigy.build_gmail_outreach_readiness_preview",
      description: "Read-only spoji Gmail account readiness, COLD-OUTREACH label stav, unread reply queue a known lead match do dalsich safe MCP krokov bez labelovania alebo odoslania.",
      requiresApproval: false,
    },
    {
    ...
    {
      name: "arcigy.build_failed_scrape_recovery_queue_preview",
      description: "Z failed alebo slabych scrape vysledkov pripravi retry scrape URL, safe fetch preview, fallback contact search a dalsie contact-selection/repair kroky bez fetchu alebo zapisu.",
      requiresApproval: false,
    },
    {
    ...
    {
      name: "arcigy.build_smartlead_send_readiness_queue_preview",
      description: "Spoji batch QA, lead scorecard, denne limity a bulk upload plan do prehladu, co sa da dnes poslat do Smartlead a co este blokuje odoslanie.",
      requiresApproval: false,
    },
    {
    ...
    {
      name: "arcigy.build_smartlead_workspace_diagnostic_preview",
      description: "Read-only workspace diagnostika zo starych Smartlead diagnostic/check-content/list-active flow: endpoint auth health, aktivne kampane, drafty, sender issues, webhook/content/deliverability dalsie kroky bez zapisu.",
      requiresApproval: false,
    },
    {
    ...
    {
      name: "arcigy.build_smartlead_campaign_delete_safety_preview",
      description: "Vyhodnoti Smartlead delete kandidatov po backupe, zablokuje protected kampane a pripravi manualny DELETE runbook bez vykonania.",
      requiresApproval: false,
    },
    {
    ...
    {
      name: "arcigy.build_leadgen_to_smartlead_dispatch_preview",
      description: "Z viac leadgen skupin pripravi jeden dispatch cez scrape/fetch, AI intra a Smartlead readiness/upload kroky bez zapisu alebo uploadu.",
      requiresApproval: false,
    },
    {
