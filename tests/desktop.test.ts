...
test("desktop shell exposes Jarvis wake-word UI and safe preload boundary", () => {
  ...
  assert.match(renderer, /Jarvis tactical radar stable/);
  assert.match(renderer, /Jarvis tactical radar tracking attention/);
