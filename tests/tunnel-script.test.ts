...
test("web tunnel script orchestrates protected Jarvis MCP exposure", () => {
  ...
  assert.match(script, /"action-manifest", "openapi-schema", "cors-preflight", "external-auth-gate", "pack-auth-throttle-policy", "pack-limits", "approval-gate", "approval-shape-gate", "secret-redaction"/);
  ...
  assert.match(script, /remote smoke status=ready with action-manifest, openapi-schema, cors-preflight, external-auth-gate, pack-auth-throttle-policy, pack-limits, approval-gate, approval-shape-gate, and secret-redaction/);
