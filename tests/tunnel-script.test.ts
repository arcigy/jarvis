...
test("web tunnel script orchestrates protected Jarvis MCP exposure", () => {
  ...
  assert.match(script, /"pack-limits", "approval-gate", "approval-shape-gate", "secret-redaction"/);
  ...
  assert.match(script, /remote smoke status=ready with pack-limits, approval-gate, approval-shape-gate, and secret-redaction/);
