...
test("Jarvis MCP server lists and calls automation tools", async () => {
  ...
  assert.ok(names.includes("arcigy.build_pricing_inventory_guard_preview"));
  assert.ok(names.includes("arcigy.build_pricing_proposal_preview"));
  assert.ok(names.includes("arcigy.build_service_capacity_preview"));
  ...
  assert.ok(names.includes("arcigy.send_slack_message"));
  ...
  assert.ok(names.includes("arcigy.build_cold_outreach_monitor_runbook_preview"));
  ...
  assert.ok(names.includes("arcigy.build_smartlead_message_history_audit_preview"));
  ...
  assert.ok(names.includes("arcigy.build_smartlead_reply_followup_queue_preview"));
  assert.ok(names.includes("arcigy.build_showcase_reply_preview"));
  assert.ok(names.includes("arcigy.preview_smartlead_ai_reply"));
  assert.ok(names.includes("arcigy.preview_gmail_ai_reply"));
  assert.ok(names.includes("arcigy.build_gmail_ai_reply_safety_runbook_preview"));
  ...
  assert.ok(names.includes("arcigy.build_failed_scrape_recovery_queue_preview"));
  assert.ok(names.includes("arcigy.build_outreach_contact_selection_preview"));
  ...
  assert.ok(names.includes("arcigy.build_gmail_name_enrichment_queue_preview"));
  assert.ok(names.includes("arcigy.build_lead_identity_repair_preview"));
  assert.ok(names.includes("arcigy.score_lead_quality"));
  assert.ok(names.includes("arcigy.build_lead_validation_scorecard_preview"));
  ...
  assert.ok(names.includes("arcigy.build_smartlead_nonreply_call_list_preview"));
  assert.ok(names.includes("arcigy.build_maps_cold_calling_export_preview"));
  ...
  assert.ok(names.includes("arcigy.build_maps_city_sweep_preview"));
  assert.ok(names.includes("arcigy.build_international_market_leadgen_preview"));
  assert.ok(names.includes("arcigy.build_leadgen_execution_queue_preview"));
  assert.ok(names.includes("arcigy.build_sticky_niche_leadgen_decision_preview"));
  assert.ok(names.includes("arcigy.build_daily_leadgen_run_closure_preview"));
  assert.ok(names.includes("arcigy.build_leadgen_run_resume_preview"));
  ...
  assert.ok(names.includes("arcigy.build_smartlead_sequence_variable_repair_preview"));
  assert.ok(names.includes("arcigy.build_company_short_name_preview"));
  assert.ok(names.includes("arcigy.build_lead_batch_qa_preview"));
  ...
  assert.ok(names.includes("arcigy.build_bulk_smartlead_upload_queue_preview"));
  assert.ok(names.includes("arcigy.build_smartlead_send_readiness_queue_preview"));
  assert.ok(names.includes("arcigy.build_smartlead_import_audit_preview"));
  assert.ok(names.includes("arcigy.build_smartlead_campaign_sync_plan_preview"));
  assert.ok(names.includes("arcigy.build_smartlead_local_reconciliation_preview"));
  assert.ok(names.includes("arcigy.build_smartlead_safe_sync_runbook_preview"));
  ...
  assert.ok(names.includes("arcigy.build_smartlead_campaign_audit_preview"));
  assert.ok(names.includes("arcigy.build_smartlead_workspace_diagnostic_preview"));
  assert.ok(names.includes("arcigy.build_smartlead_campaign_backup_plan"));
  assert.ok(names.includes("arcigy.build_smartlead_campaign_delete_safety_preview"));
  assert.ok(names.includes("arcigy.build_smartlead_campaign_restore_plan"));
  ...
  assert.ok(names.includes("arcigy.build_smartlead_fixed_campaign_package_preview"));
  ...
  assert.ok(names.includes("arcigy.build_leadgen_to_smartlead_dispatch_preview"));
  assert.ok(names.includes("arcigy.build_company_research_queue_preview"));
  assert.ok(names.includes("arcigy.build_research_results_import_preview"));
  ...
  assert.ok(names.includes("arcigy.build_lead_source_bundle_campaign_launch_preview"));
  ...
  assert.ok(names.includes("arcigy.build_phone_enrichment_queue_preview"));
  assert.ok(names.includes("arcigy.build_phone_enrichment_writeback_preview"));
  assert.ok(names.includes("arcigy.build_orphan_lead_assignment_preview"));
  ...
  assert.ok(names.includes("arcigy.build_full_leadgen_pipeline_runbook_preview"));
  ...
  assert.ok(names.includes("arcigy.build_flagged_lead_review_preview"));
  assert.ok(names.includes("arcigy.build_ai_intro_work_packet_preview"));
  assert.ok(names.includes("arcigy.build_bulk_ai_intro_work_queue_preview"));
  ...
  assert.ok(pack.tools.approvalRequired.includes("arcigy.send_slack_message"));
  ...
  assert.ok(pack.quickStartCalls.some((call) => call.tool === "arcigy.build_failed_scrape_recovery_queue_preview" && call.approvalRequired === false));
  ...
  assert.ok(pack.quickStartCalls.some((call) => call.tool === "arcigy.build_leadgen_run_resume_preview" && call.approvalRequired === false));
  ...
  assert.ok(pack.quickStartCalls.some((call) => call.tool === "arcigy.build_service_capacity_preview" && call.approvalRequired === false && Array.isArray(call.body.services)));
